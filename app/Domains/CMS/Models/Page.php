...
class Page extends BaseModel
{
    ...
    protected function casts(): array { return ['status' => PublicationStatus::class, 'visibility' => Visibility::class, 'template' => PageTemplate::class, 'published_at' => 'datetime', 'scheduled_at' => 'datetime', 'view_count' => 'integer', 'sort_order' => 'integer', 'custom_fields' => 'array']; }
