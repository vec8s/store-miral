...
class Media extends BaseModel
{
    ...
    {
        return ['collection' => MediaCollection::class, 'disk' => MediaDisk::class, 'size' => 'integer', 'width' => 'integer', 'height' => 'integer', 'responsive_images' => 'array', 'sort_order' => 'integer'];
    }
    ...
    public function scopeInCollection($q, MediaCollection $c)
    {
        return $q->where('collection', $c);
    }
}
