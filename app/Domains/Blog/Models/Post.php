...
class Post extends BaseModel
{
    ...
    {
        return ['status' => PublicationStatus::class, 'visibility' => Visibility::class, 'layout' => PostLayout::class, 'is_featured' => 'boolean', 'allow_comments' => 'boolean', 'view_count' => 'integer', 'reading_time_minutes' => 'integer', 'published_at' => 'datetime', 'scheduled_at' => 'datetime', 'custom_fields' => 'array'];
    }
