...
class WebhookEvent extends BaseModel
{
    ...
    protected function casts(): array { return ['event_type' => WebhookEventType::class, 'status' => WebhookEventStatus::class, 'payload' => 'array', 'headers' => 'array', 'attempts' => 'integer', 'response_status' => 'integer', 'received_at' => 'datetime', 'processed_at' => 'datetime', 'failed_at' => 'datetime']; }
