...
class WebhookEndpoint extends BaseModel
{
    ...
    protected function casts(): array { return ['algorithm' => SignatureAlgorithm::class, 'subscribed_events' => 'array', 'is_active' => 'boolean', 'timeout_seconds' => 'integer', 'max_retries' => 'integer', 'last_triggered_at' => 'datetime', 'total_deliveries' => 'integer', 'failed_deliveries' => 'integer']; }
    public function events(): HasMany { return $this->hasMany(WebhookEvent::class); }
