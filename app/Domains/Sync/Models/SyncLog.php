...
class SyncLog extends BaseModel
{
    ...
    {
        return ['action' => SyncAction::class, 'attempt_number' => 'integer', 'duration_ms' => 'integer', 'before_state' => 'array', 'after_state' => 'array', 'error_context' => 'array', 'occurred_at' => 'datetime'];
    }
