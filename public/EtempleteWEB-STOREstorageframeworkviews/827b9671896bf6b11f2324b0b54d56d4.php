...
$__newAttributes = [];
$__propNames = ComponentAttributeBag::extractPropNames((['queries']));
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.icons.database', 'data' => ['class' => 'w-2.5 h-2.5 text-blue-500 dark:text-emerald-500']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php } ?>
        ...
        <div x-show="totalQueries > 0" class="text-sm text-neutral-500 dark:text-neutral-400 flex items-center gap-2">
            ...
            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (count($queries) > 100) { ?>
                <?php if (isset($component)) {
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.icons.info', 'data' => ['class' => 'w-3 h-3 text-blue-500 dark:text-emerald-500', 'dataTippyContent' => 'Only the first 100 queries are shown']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.icons.database', 'data' => ['class' => 'w-3 h-3 text-neutral-500 dark:text-neutral-400']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('laravel-exceptions-renderer::icons.database'); ?>
<?php if ($component->shouldRender()) { ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof ComponentAttributeBag) { ?>
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.syntax-highlight', 'data' => ['code' => $sql, 'language' => 'sql', 'truncate' => true, 'class' => 'min-w-0', 'dataTippyContent' => ''.e(nl2br($sql)).'']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(AnonymousComponent::ignoredParameterNames()); ?>
<?php } ?>
<?php $component->withAttributes(['code' => BladeCompiler::sanitizeComponentAttribute($sql), 'language' => 'sql', 'truncate' => true, 'class' => 'min-w-0', 'data-tippy-content' => ''.e(nl2br($sql)).'']); ?>
<?php SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.empty-state', 'data' => ['message' => 'No queries executed']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.icons.chevrons-left', 'data' => ['class' => 'w-3 h-3']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.icons.chevron-left', 'data' => ['class' => 'w-3 h-3']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.icons.chevron-right', 'data' => ['class' => 'w-3 h-3']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.icons.chevrons-right', 'data' => ['class' => 'w-3 h-3']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
