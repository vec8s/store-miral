...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.file-with-line', 'data' => ['frame' => $exception->frames()->first(), 'class' => '-mt-3 text-xs']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php } ?>
<?php $component->withAttributes(['frame' => BladeCompiler::sanitizeComponentAttribute($exception->frames()->first()), 'class' => '-mt-3 text-xs']); ?>
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.badge', 'data' => ['type' => 'error']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.request-url', 'data' => ['exception' => $exception, 'request' => $exception->request(), 'class' => 'relative z-50']] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(AnonymousComponent::ignoredParameterNames()); ?>
<?php } ?>
<?php $component->withAttributes(['exception' => BladeCompiler::sanitizeComponentAttribute($exception), 'request' => BladeCompiler::sanitizeComponentAttribute($exception->request()), 'class' => 'relative z-50']); ?>
<?php SupportCompiledWireKeys::processComponentKey($component); ?>
