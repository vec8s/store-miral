...
$__newAttributes = [];
$__propNames = ComponentAttributeBag::extractPropNames((['headers']));
...
<div class="flex flex-col gap-3">
    ...
    <div class="flex flex-col">
        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $headers;
